...
if __name__ == '__main__':
    ...
    ax3.plot(source.time, flatten_lc_, '.k', ms=2)
    ax4.plot(source.time, flatten_lc, '.k', ms=2)
    ...
    ax3.set_title('detrended Moffat PSF', loc='left')
    ax4.set_title('detrended ePSF', loc='left')
    ax1.set_xticklabels([])
    ...
    ax3.plot(source.time[t3:], flatten_lc_[t3:], '.', c='silver', ms=2)
    ax3.plot(source.time[t1:t2], flatten_lc_[t1:t2], '.', c='silver', ms=2)
    ax4.plot(source.time[t3:], flatten_lc[t3:], '.', c='silver', ms=2)
    ax4.plot(source.time[t1:t2], flatten_lc[t1:t2], '.', c='silver', ms=2)
